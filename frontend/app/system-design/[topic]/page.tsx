        ...
        {subsection.sections?.map((contentSection) => (
          ...
          >
            <div className="rounded-lg border border-border/40 bg-card p-8">
              ...
              {!['introduction', 'sql-vs-nosql', 'indexing', 'sharding', 'replication', 
                  'authentication', 'authorization', 'encryption', 'caching', 'load-balancing', 
                  'cdn', 'optimization', 'microservices', 'event-driven', 'monolithic', 
                  'serverless', 'examples', 'best-practices', 'protocols', 'tcp-udp', 
                  'http-https', 'dns'].includes(contentSection.id) && (
                <div className="space-y-4">
                  <p className="text-muted-foreground">
                  ...
                  <div className="p-4 rounded-md bg-accent/50 border border-border/40">
                    <p className="text-sm text-muted-foreground">
                      ...
                      in the context of {subsection.name.toLowerCase()}.
                    </p>
                  </div>
                </div>
              )}
