 ...
 * 
 * Features:
 * - Displays all main sections from the sections configuration
 * - Highlights active section based on current route
 * - Responsive design with mobile hamburger menu
 * - Sticky positioning for easy navigation
 * - Automatic updates when sections.ts is modified
 * 
 * @module Navbar
 */
 ...
 * 
 * This component automatically stays in sync with sections.ts configuration.
 * No changes needed here when adding/removing sections.
 */
