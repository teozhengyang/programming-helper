 ...
 * 
 * Features:
 * - Playful doodle-inspired background
 * - Staggered animations using Framer Motion
 * - Concise taglines with crayon typography
 * - Compact section chips linking to key areas
 * - Fully responsive design
 * 
 * This component showcases the site's value proposition and guides users
 * to start exploring content.
 * 
 * @module HeroSection
 */
...
/**
 * HeroSection component - landing page hero with animations and CTAs
 * 
 * Animation pattern:
 * - Elements animate sequentially with staggered delays
